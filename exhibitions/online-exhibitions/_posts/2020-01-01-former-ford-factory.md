...
date: 2020-01-01
permalink: /exhibitions/online-exhibitions/former-ford-factory
---

{% assign event-details = site.data.event-list %}

{% for thisevent in event-details.event %}
{% if thisevent.short-name == "formerford" %}
<!--
...
[Visit Exhibition](http://www.nlb.gov.sg/exhibitions/virtual/fff360/FFF360.html){: .dl-style-2 target="_blank"}
</div>
<!-- ------------------------------------------------------CONTENT-END------------------------------------------------------------- -->
  </div>
