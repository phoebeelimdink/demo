...
date: 2020-01-01
permalink: /exhibitions/online-exhibitions/law-of-the-land
---

{% assign event-details = site.data.event-list %}

{% for thisevent in event-details.event %}
{% if thisevent.short-name == "lawoftheland" %}
<!--
...
[Visit Exhibition](http://www.nlb.gov.sg/exhibitions/virtual/lotl360/LOTL360.html){: .dl-style-2 target="_blank"}
</div>
<!-- ------------------------------------------------------CONTENT-END------------------------------------------------------------- -->
  </div>
