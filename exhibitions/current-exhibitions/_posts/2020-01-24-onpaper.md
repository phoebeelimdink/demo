...
<!-- ------------------------------------------------------CONTENT-END------------------------------------------------------------- -->
  ...
  <div id="tab4">
    ...
    <div class="featured-video-wrap">
      ...
      {% if featuredvideo.video-subtitle== "" %}{% else %}<p><strong>{{featuredvideo.video-subtitle}}</strong></p>{% endif %}
      {% if featuredvideo.video-description== "" %}{% else %}<p>{{featuredvideo.video-description}}</p>{% endif %}
      {% endfor %}
    </div>
  </div>
  {% else %}
