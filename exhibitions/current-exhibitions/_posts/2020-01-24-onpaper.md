...
<!-- ------------------------------------------------------CONTENT-END------------------------------------------------------------- -->
  ...
  <div id="tab3">
    ...
    <div class="exhibition-highlights-wrap">
      ...
      {% if eventhighlight.highlight-subtitle== "" %}{% else %}<p markdown="1"><strong>{{eventhighlight.highlight-subtitle}}</strong></p>{% endif %}
      {% if eventhighlight.highlight-text== "" %}{% else %}<p markdown="1">{{eventhighlight.highlight-text}}</p>{% endif %}
      {% endfor %}
    </div>
  </div>
  {% else %}
